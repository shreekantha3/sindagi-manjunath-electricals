# Manjunath Electricals — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-manjunath-electricals/
- **Repo:** `shreekantha3/sindagi-manjunath-electricals` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-manjunath-electricals/'` for GitHub Pages project-site hosting.
